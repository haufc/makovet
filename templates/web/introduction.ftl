        ...
        <div class="container" style="padding-left:30px;">
            ...
            <div class="img-responsive new-detail__content" style="color: #636466; font-size: 16px; padding-top:30px;line-height: 1.5; padding-bottom: 60px;">${contentModel.content_html}</div>
