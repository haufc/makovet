        ...
        <div class="container" style="padding-left:30px;">
            ...
            <section class="foot__introduction">
                    <section class="foot__introduction-item intro-first">
                        <a class="button" href="${contentModel.url1_s}" >${contentModel.button1_s}</a>
                    </section>
                    <section class="foot__introduction-item intro-mid">
                        <a class="button" href="${contentModel.url2_s}">${contentModel.button2_s}</a>
                    </section>
                    <section class="foot__introduction-item intro-last">
                        <a class="button" href="${contentModel.url3_s}">${contentModel.button3_s}</a>
                    </section>
                </section>
        </div>
        </section>