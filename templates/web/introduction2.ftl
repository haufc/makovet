    ...
    <div class="container">
        <section class="introduce" style="max-width:1145px; width: 100%;">
            <div class="introduce__item">
                ...
                <p class="introduce__item-text introduce__item-text--purple text--uppercase font-title font-bold" style="font-weight:500; font-size:18px;">${contentModel.titleintro_s}</p>
            ...
            <div class="introduce__item">
                ...
                <p class="introduce__item-text introduce__item-text--yellow text--uppercase font-title font-bold" style="font-weight:500; font-size:18px;">${contentModel.titlehistory_s}</p>
            ...
            <div class="introduce__item">
                ...
                <p class="introduce__item-text introduce__item-text--purple text--uppercase font-title font-bold" style="font-weight:500; font-size:18px;">${contentModel.titlevision_s}</p>
                <img class="introduce__item-bg" src="/static-assets/images/slides/introduce_bg_yellow.png" alt="Introduce background">
            ...
            <div class="introduce__item">
                ...
                <p class="introduce__item-text introduce__item-text--yellow text--uppercase font-title font-bold" style="font-weight:500; font-size:18px;">${contentModel.titleaward_s}</p>
                <img class="introduce__item-bg" src="/static-assets/images/slides/introduce_bg_purple.png" alt="Introduce background">
