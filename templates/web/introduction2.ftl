    ...
    <div class="container">
        <section class="introduce" style="max-width:1145px; width: 100%;">
            <div class="introduce__item">
                ...
                <img class="introduce__item-img full-size" src="${contentModel.introduction_s}" alt="Introduce image"></a>
            </div>

            <div class="introduce__item">
                <a class="introduce__item-link" href="${contentModel.urlhistory_s}">
                ...
                <img class="introduce__item-img full-size" src="${contentModel.history_s}" alt="Introduce image"></a>
            </div>

            <div class="introduce__item">
                <a class="introduce__item-link" href="${contentModel.urlvision_s}">
                ...
                <img class="introduce__item-bg" src="/static-assets/images/slides/introduce_bg_yellow.png" alt="Introduce background">
                <img class="introduce__item-img full-size" src="${contentModel.vision_s}" alt="Introduce image"></a>
            </div>

            <div class="introduce__item">
                <a class="introduce__item-link" href="${contentModel.urlaward_s}">
                ...
                <img class="introduce__item-bg" src="/static-assets/images/slides/introduce_bg_purple.png" alt="Introduce background">
                <img class="introduce__item-img full-size" src="${contentModel.award_s}" alt="Introduce image"></a>
            </div>
        </section>
    </div>
</div>
