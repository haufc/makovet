        ...
        <div class="content">
            ...
            <div class="container">
                 <div class="d-flex mb-4" style="background-color: #ffcb0c;">
                        <div class="product-name m-auto"><h1 class="font-weight-bold violet-color text-center" style="font-size: 20px;">${contentModel.productName_s}</h1></div>
                        <div class="product-image" style="padding: 3%;"><img class="img-center" src="${contentModel.productImage_s}"/></div>
                        <div class="product-buy text-center m-auto"><span class="product-buy text-white font-weight-bold">Đặt mua</span></div>
                </div>
