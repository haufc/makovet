        ...
        <div class="content">
            ...
            <div class="container">
                 <div class="d-flex mb-4" style="background-color: #ffcb0c;">
                        ...
                        <div class="product-info product-image" style="padding: 3%;"><img style="    display: block;margin-left: auto;margin-right: auto;" src="${contentModel.productImage_s}" width="254" height="262"/></div>
