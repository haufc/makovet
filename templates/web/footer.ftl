...
<footer class="footer" <@studio.iceAttr component=contentModel/>>
    <div class="footer__container block flex">
        ...
        <section class="footer__item-address" id="address">
            ...
            <p class="mb-5 " style="font-weight: 100; font-size: 13px;">Chứng nhận Đăng ký Kinh doanh số số 1200505472 - Ngày cấp: 28/01/2002  - Nơi cấp: Sở KHĐT tỉnh Tiền Giang </p>
        </section>
        <!-- /address -->
    ...
    <div class="block flex" style="width:100%; justify-content:center; background: #322372;">
            <a href="http://cailayvetco.com/"<p class="footer__item-title font-bold font-title text--center" style="font-size: 16px; padding-top:10px; color:#fff">Quay lại giao diện cũ website Mekovet</p></a>
    </div>
</footer>
<@studio.toolSupport />