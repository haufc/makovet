    ...
    <div class="footer__container block flex">
        ...
        <section class="footer__item text--center" id="social">
            ...
            <ul class="footer__item-btns flex">
                <li><a href="${contentModel.fburl_s}"><img src="../settings/images/btn_facebook.png" alt="Facebook"></a></li>
                <li><a href="${contentModel.twitterurl_s}"><img src="../settings/images/btn_twitter.png" alt="Twitter"></a></li>
                <li><a href="${contentModel.youtubeurl_s}"><img src="../settings/images/btn_youtube.png" alt="Youtube"></a></li>
                <li><a href="${contentModel.linkedinurl_s}"><img src="../settings/images/btn_linkedin.png" alt="Linkedin"></a></li>
            </ul>
        </section>
        <!-- /social -->
