    ...
    <div class="services__container block flex">
        ...
        <section class="services__content">
                <div class="services__content-text">
                    <h3 class="text--uppercase font-roboto" style="font-weight: bold; font-size: 25px;margin-bottom: 15px; color: #322372;" >${contentModel.title_s}</h3>
                ...
                <a class="view-more flex" href="/ho-tro-ky-thuat/benh-va-dieu-tri">
                    <span class="font-bold font-roboto" style="color: #322372;">Xem thêm</span>
